...
const String Master1 = "1234A";
const String Master = "A1B2C34";
String Data, Data1;
...

{
...

  {
    ...
    if (Data1 == Master1) // equal to (strcmp(Data, Master) == 0)
   ...
   else  // makes sure a key is actually pressed, equal to (customKey != NO_KEY)

  {

    Data1 += customKey; // store char into data array
...

{
...

  {
    ...
    if (Data ==  Master) // equal to (strcmp(Data, Master) == 0)
...

  {
    ...
    Data += customKey; // store char into data array

    lcd.setCursor(data_count, 1); // move cursor to show each new char

    lcd.print(Data); // print char at said cursor
